...
namespace ProjectileCollisionDemo.Editor
{
    ...
    public sealed class PhaseThreeMovementProbe
    {
        ...
        private readonly MethodInfo query = typeof(SphereCastAllDetector).GetMethod("TryGetNearestHit", BindingFlags.Instance | BindingFlags.NonPublic);
        ...
        public PhaseThreeMovementProbe(ProjectileTestRunner owner, ProjectilePool source)
        {
            ...
            for (int i = 0; i < loop.subSystemList.Length; i++)
            {
                ...
                systems.Insert(index, new PlayerLoopSystem { type = typeof(PhaseThreeMovementProbe), updateDelegate = FixedUpdate });
